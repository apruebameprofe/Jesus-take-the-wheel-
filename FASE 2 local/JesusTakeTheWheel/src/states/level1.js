JesusTakeTheWheel.level1State = function(game) {
}
//Variables globales
...
function initPhysics () {
   ...
   //Mapa de colisiones
   map = game.add.tilemap('mapatest1',20,20); //Añade a map (declarado en global) un tilemap que ya hemos cargado
   ...
   map2 = game.add.tilemap('mapabombas1',20,20);
...
function initPlayer(){
   ...
   player = game.add.sprite(1300, 20, 'racersprite',subchar[0]); //Le da un sprite en la posición 600,20 , con el tile 0 del tileset arrowsprite 
...
JesusTakeTheWheel.level1State.prototype = {
