...
Jesus.preloadState.prototype = {
  preload: function() {
    ...
    game.load.spritesheet(
      "racersprite",
      "../assets/images/corredores.png",
      60,
      60
    );

    game.load.image("serverlleno", "../assets/images/serverlleno.png");
    game.load.image("comprobandoserver", "../assets/images/comprobandoelserver.png");
    ...
    game.load.spritesheet(
      "vallaDerecha",
      "../assets/images/vallaDerecha.png",
      45,
      45
    );
    game.load.spritesheet(
      "vallaIzquierda",
      "../assets/images/vallaIzquierda.png",
      45,
      45
    );
    game.load.spritesheet(
      "corazonSprite",
      "../assets/images/corazonSprite.png",
      45,
      45
    );
    game.load.spritesheet(
      "bombasprite",
      "../assets/images/bombaSprite.png",
      45,
      45
    );
    ...
    game.load.spritesheet(
      "opcionespersonaje",
      "../assets/images/opcionespersonaje2.png",
      200,
      100
    );
    game.load.spritesheet(
      "opcionespista",
      "../assets/images/opcionespista.png",
      200,
      45
    );
    ...
    game.load.image(
      "interfazPersonaje",
      "../assets/images/interfazpersonajes.png"
    );
    ...
    game.load.image(
      "buscandojugadores",
      "../assets/images/buscandojugadores.png"
    );
