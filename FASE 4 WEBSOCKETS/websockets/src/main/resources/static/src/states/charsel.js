...
function listenDerecha(){//Funcion del boton de flechita derecha
...
function listenIzquierda(){//Lo mismo pero con la izquierda
...
function listener3(){//Funcion que escucha al boton de play 
   clicked3 = true; 
}
