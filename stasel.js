JesusTakeTheWheel.staselState = function(game) {
}
var hitsAvailable;
var speedAvailable;
var pistaSelect = 1; 
...
JesusTakeTheWheel.staselState.prototype = {
    init: function() {
    ...
    create: function() {
       ...
       game.world.setBounds(0,0,1000,800);
        ...
        opcionesl = game.add.sprite(game.world.centerX-10,game.world.centerY-50,'opcionespista',0);
       ...
       var derecha2 = game.add.sprite( game.world.centerX+160 , game.world.centerY-50, 'flecha');
       ...
       derecha2.events.onInputDown.add(listenDerecha2, this);
        var izquierda2 = game.add.sprite( game.world.centerX-200 , game.world.centerY-50 , 'flecha');
       ...
       izquierda2.events.onInputDown.add(listenIzquierda2, this);
        ...
        var startbutton = game.add.sprite( game.world.centerX-10 , game.world.centerY+110, 'play3');
